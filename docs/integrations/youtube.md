...
{% shot "youtube-timestamp-hud", "a paused YouTube video with Pinza's HUD showing the copied youtu.be link ending in ?t=213, the “Title — Channel” label, and the channel avatar on the pin.", "hud" %}
...
{% shot "browser-allow-js-menu", "Safari's Develop menu open with “Allow JavaScript from Apple Events” checked — with a small inset of the same item in Chrome's View → Developer menu.", "menu" %}
